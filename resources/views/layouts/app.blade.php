        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- <li class="nav-item">
                <a class="nav-link" href="/barang/create">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Tambah Barang Masuk</span></a>
            </li> -->
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('daftarBarangKeluar')}}">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Daftar Barang Keluar</span></a>
            </li>
            <!-- <li class="nav-item">
            ...
            <!-- <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Jenis Operasi</h6>
                        <a class="collapse-item" href="/penambahan">Penambahan</a>
            ...
            <!-- <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/barang_rusak">Barang Rusak</a>
            ...
            <!-- <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{Route('merk.create')}}">Tambah Merk</a>
